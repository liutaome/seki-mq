...
@Component
@Lazy
public class MessageRabbitBListener implements ChannelAwareMessageListener{
	
	private static final Logger logger = LoggerFactory.getLogger(MessageRabbitBListener.class);
	...
	public void onMessage(Message message, Channel channel) throws Exception {
		logger.info("MessageRabbitBListener收到消息"+message);
