...
@Component
@Lazy
public class MessageAutoCommitRabbitAListener implements MessageListener{
	
	private static final Logger logger = LoggerFactory.getLogger(MessageAutoCommitRabbitAListener.class);
	...
	public void onMessage(Message arg0) {
		logger.info("MessageAutoCommitRabbitAListener收到消息=="+arg0);
