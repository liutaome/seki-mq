...
@Component
@Lazy
public class MessageRocketAListener implements MessageListenerConcurrently{
	
	private static final Logger logger = LoggerFactory.getLogger(MessageRocketAListener.class);
	...
	public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs,
			...
			if(msgs!=null && msgs.size()>0){
				logger.info("MessageRocketAListener收到消息=="+msgs.get(0));
			}
